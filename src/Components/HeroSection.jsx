...
const HeroSection = () => {
  return (
    <div className="lg:w-[85%] w-[95%] mx-auto py-20 flex lg:flex-row flex-col justify-center items-center lg:gap-0 gap-10">
      <div className="lg:w-1/2 w-[95%] flex flex-col lg:items-start  items-center">
        ...
        <form className="mb-3 w-full flex flex-col lg:items-start  items-center">
          <input
            type="text"
            placeholder="Enter your work email"
            className="md:w-[70%] w-[100%] border border-slate-500 px-3 py-2 rounded-full mb-3"
          />
          <Button children="Sign up free" width="md:w-[70%] w-[100%]" />
          <p className="text-slate-400 text-sm mb-10 mt-5">
      ...
      <div className="lg:w-1/2 w-[95%]">
        <img src="images/hero-image.png" alt="" className="w-[90%] mx-auto" />
      </div>
    </div>
  );
};
